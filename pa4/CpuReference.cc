...
void __cpu_fftx(float *real_image, float *imag_image, int size_x, int size_y)
{
...
void __cpu_ifftx(float *real_image, float *imag_image, int size_x, int size_y)
{
  // Create some space for storing temporary values
  float *realOutBuffer = new float[size_x];
  float *imagOutBuffer = new float[size_x];
...
void __cpu_ffty(float *real_image, float *imag_image, int size_x, int size_y)
{
...
void __cpu_iffty(float *real_image, float *imag_image, int size_x, int size_y)
{
  // Create some space for storing temporary values
  float *realOutBuffer = new float[size_y];
  float *imagOutBuffer = new float[size_y];
...
void __cpu_filter(float *real_image, float *imag_image, int size_x, int size_y)
{
  int eightX = size_x/8;
...
float referenceCleaner(float *real_image, float *imag_image, int size_x, int size_y)
{
  ...
  __cpu_fftx(real_image, imag_image, size_x, size_y);
  // Perform fft with respect to the y direction
  __cpu_ffty(real_image, imag_image, size_x, size_y);

  // Filter the transformed image
  __cpu_filter(real_image, imag_image, size_x, size_y);

  // Perform an inverse fft with respect to the x direction
  __cpu_ifftx(real_image, imag_image, size_x, size_y);
  // Perform an inverse fft with respect to the y direction
  __cpu_iffty(real_image, imag_image, size_x, size_y);
